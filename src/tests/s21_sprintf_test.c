...
START_TEST(sprintf_g) {
  char str1[200] = {0};
  char str2[200] = {0};
  char *str3 = "<%g>|<%g>|<%g>|<%4g>|<%5.6g>|<%g>";
  double num = -57251397732103429.56589367;
  // sprintf(str1, str3, num, 1000., 10.1, num, num);
  // s21_sprintf(str2, str3, num, 1000., 10.1, num, num);
  // printf("%s\n%s\n", str2, str1);
  ck_assert_int_eq(sprintf(str1, str3, num, 1000., 10.1, num, num, 0.001),
                   s21_sprintf(str2, str3, num, 1000., 10.1, num, num, 0.001));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(s21_sprintf_g) {
  char str1[200] = "";
  char str2[200] = "";
  char *str3 = "<%g>|<%.0g>|<%4.2g>|<%4.g>|<%5.9g>";
  double num = -57251387732103429.56589367;
...
START_TEST(g_many) {
  char str1[200] = "";
  char str2[200] = "";
  char format[] = "%LG %g %G %Lg %.9Lg %.2g";
  long double hex = 0.000005;
  double hex1 = 41.1341;
  double hex2 = 848.9000;
  long double hex3 = 0.0843;
  long double hex4 = 0.000005;
  double hex5 = 0.0481481;
...
TCase *s21_sprintf_test(void) {
  ...
  tcase_add_test(tcase, sprintf_u);
  tcase_add_test(tcase, sprintf_x);
  tcase_add_test(tcase, sprintf_g);
  tcase_add_test(tcase, sprintf_p);
  tcase_add_test(tcase, sprintf_o);
  tcase_add_test(tcase, sprintf_on);
  tcase_add_test(tcase, sprintf_x);
  tcase_add_test(tcase, sprintf_e);
  tcase_add_test(tcase, sprintf_E);
  tcase_add_test(tcase, sprintf_c);
  tcase_add_test(tcase, sprintf_f);
  tcase_add_test(tcase, sprintf_i);
  tcase_add_test(tcase, sprintf_s);
  tcase_add_test(tcase, sprintf_h);
  tcase_add_test(tcase, sprintf_l);
  tcase_add_test(tcase, sprintf_empty);
  tcase_add_test(tcase, s21_sprintf_g);
  tcase_add_test(tcase, g_many);
